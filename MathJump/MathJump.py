...
# Background
BACKGROUND = pygame.transform.scale(pygame.image.load(os.path.join('AssetsIntegrador','BACKGROUND.png')), (WIDTH,HEIGHT))

# Character
CHARACTER_WIDTH, CHARACTER_HEIGHT = 60, 60
CHARACTER = pygame.transform.scale(pygame.image.load(os.path.join('AssetsIntegrador','CHARACTER.png')), (CHARACTER_WIDTH,CHARACTER_HEIGHT))
Y_SPEED = 4
X_SPEED = 2
